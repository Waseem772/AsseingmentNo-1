...
const [object_1 , object_2 , object_3 , object_4 , object_5] = object_array;
...
{    div.innerHTML += 
    ...
    <img src="${object_array[i].image_url}" class="card-img-top" alt="...">
    <div class="card-body">
      <h4 class="card-title">${object_array[i].title} </h4>
      <h6 class="card-text">${object_array[i].description}</h6>
      <p class="card-text"> <strong>${object_array[i].price}</strong> </p>
